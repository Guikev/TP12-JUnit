...
public class MarqueTest {
	...
	public void testcaMarque() {
		...
		circuit1 = new Circuit("WWF", 50.30, 10000, 0.5, voitures);
		circuit2 = new Circuit("WWF", 50.30, 10000, 0.4, voitures);
		circuit3 = new Circuit("WWF", 50.30, 10000, 0.3, voitures);
		
		circuits.add(circuit1);
		circuits.add(circuit2);
		circuits.add(circuit3);
		
		uneMarque = new Marque("Marie");
		uneMarque.setLesCircuits(circuits);
		
		//Test
		assertEquals("Resultat ca marque non conforme", uneMarque.caMarque(), 42000,0);
	}
